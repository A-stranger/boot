<template>
  <div v-loading="loading">
    <div style="margin:20px 0 0 0">
      <e-container>
        <div style="margin:20px 0 0 0;background-color:#FFFFFF;box-shadow:0px 0px 3px 3px #E7E7E7">
          <e-module-widget-title title="新闻信息列表">
                  ...
                  <tr>
                    ...
                    <td>
                      <p class="search-radio">
                        ...
                        <a href="javascript:;"
                           v-for="r in mapxinwenfenlei1"
                           @click="selectRadio('fenlei',r.id)" :class="{active:search.fenlei == r.id}"
