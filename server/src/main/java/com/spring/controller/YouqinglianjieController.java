...
public class YouqinglianjieController extends BaseController
{
    ...
    public String insert()
    {
        ...
        Query.execute("INSERT INTO logs(module,operationtype,operationcontent,cx,username) values('友情链接' , '新增' , '网站名称："+request.getParameter("wangzhanmingcheng")+"<br>网址："+request.getParameter("wangzhi")+"' , '"+request.getSession().getAttribute("cx")+"' , '"+request.getSession().getAttribute("username")+"')");
    ...
    */
    ...
    public String update()
    {
        ...
        int charuid = post.getId().intValue();
        Query.execute("INSERT INTO logs(module,operationtype,operationcontent,cx,username) values('友情链接' , '更新' , '网站名称："+request.getParameter("wangzhanmingcheng")+"<br>网址："+request.getParameter("wangzhi")+"' , '"+request.getSession().getAttribute("cx")+"' , '"+request.getSession().getAttribute("username")+"')");
    ...
    */
    ...
    public String delete()
    {
        ...
        Query.execute("INSERT INTO logs(module,operationtype,operationcontent,cx,username) values('友情链接' , '删除' , '网站名称："+map.get("wangzhanmingcheng")+"<br>网址："+map.get("wangzhi")+"' , '"+request.getSession().getAttribute("cx")+"' , '"+request.getSession().getAttribute("username")+"')");
