...
abstract public class BaseController {
    ...
    protected boolean isAjax()
    {
        ...
        //xRequestedWith为空是同步请求，为X-Requested-With则为Ajax请求
    ...
    {
        //request.getSession().getAttribute是获取session中的数据，获取的是Object类型。返回值null和“”不一样
