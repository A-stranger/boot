...
public class XinwenxinxiController extends BaseController
{
    ...
    */
    ...
    public String index()
    {
        ...
        page = Math.max(1 , page);
                ...
                assign("mapxinwenfenlei1" , new CommDAO().select("SELECT id,fenleimingcheng FROM xinwenfenlei"));        assign("totalCount" , request.getAttribute("totalCount"));
        assign("list" , list);
        assign("where" , where);
        assign("orderby" , order);
        assign("sort" , sort);
    ...
    public String insert()
    {
        ...
        Query.execute("INSERT INTO logs(module,operationtype,operationcontent,cx,username) values('新闻信息' , '新增' , '标题："+request.getParameter("biaoti")+"' , '"+request.getSession().getAttribute("cx")+"' , '"+request.getSession().getAttribute("username")+"')");
    ...
    */
    ...
    public String update()
    {
        ...
        int charuid = post.getId().intValue();
        Query.execute("INSERT INTO logs(module,operationtype,operationcontent,cx,username) values('新闻信息' , '更新' , '标题："+request.getParameter("biaoti")+"' , '"+request.getSession().getAttribute("cx")+"' , '"+request.getSession().getAttribute("username")+"')");
    ...
    public String detailweb()
    {
        ...
        Query.execute("UPDATE xinwenxinxi SET dianjilv=dianjilv+1 WHERE id="+request.getParameter("id")+"");
                    ...
                    assign("prev" , new CommDAO().find("SELECT * FROM xinwenxinxi WHERE id<'"+request.getParameter("id")+"' ORDER BY id desc"));
            assign("next" , new CommDAO().find("SELECT * FROM xinwenxinxi WHERE id>'"+request.getParameter("id")+"' ORDER BY id desc"));        
                if(!checkLogin()){
    ...
    */
    ...
    public String delete()
    {
        ...
        Query.execute("INSERT INTO logs(module,operationtype,operationcontent,cx,username) values('新闻信息' , '删除' , '标题："+map.get("biaoti")+"' , '"+request.getSession().getAttribute("cx")+"' , '"+request.getSession().getAttribute("username")+"')");
