...
public class XinwenfenleiController extends BaseController
{
    ...
    public String insert()
    {
        ...
        Query.execute("INSERT INTO logs(module,operationtype,operationcontent,cx,username) values('新闻分类' , '新增' , '分类名称："+request.getParameter("fenleimingcheng")+"' , '"+request.getSession().getAttribute("cx")+"' , '"+request.getSession().getAttribute("username")+"')");
    ...
    */
    ...
    public String update()
    {
        ...
        int charuid = post.getId().intValue();
        Query.execute("INSERT INTO logs(module,operationtype,operationcontent,cx,username) values('新闻分类' , '更新' , '分类名称："+request.getParameter("fenleimingcheng")+"' , '"+request.getSession().getAttribute("cx")+"' , '"+request.getSession().getAttribute("username")+"')");
    ...
    */
    ...
    public String delete()
    {
        ...
        Query.execute("INSERT INTO logs(module,operationtype,operationcontent,cx,username) values('新闻分类' , '删除' , '分类名称："+map.get("fenleimingcheng")+"' , '"+request.getSession().getAttribute("cx")+"' , '"+request.getSession().getAttribute("username")+"')");
