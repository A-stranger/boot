...
public class LunbotuController extends BaseController
{
    ...
    public String insert()
    {
        ...
        Query.execute("INSERT INTO logs(module,operationtype,operationcontent,cx,username) values('轮播图' , '新增' , '标题："+request.getParameter("title")+"<br>连接地址："+request.getParameter("url")+"' , '"+request.getSession().getAttribute("cx")+"' , '"+request.getSession().getAttribute("username")+"')");
    ...
    */
    ...
    public String update()
    {
        ...
        int charuid = post.getId().intValue();
        Query.execute("INSERT INTO logs(module,operationtype,operationcontent,cx,username) values('轮播图' , '更新' , '标题："+request.getParameter("title")+"<br>连接地址："+request.getParameter("url")+"' , '"+request.getSession().getAttribute("cx")+"' , '"+request.getSession().getAttribute("username")+"')");
    ...
    */
    ...
    public String delete()
    {
        ...
        Query.execute("INSERT INTO logs(module,operationtype,operationcontent,cx,username) values('轮播图' , '删除' , '标题："+map.get("title")+"<br>连接地址："+map.get("url")+"' , '"+request.getSession().getAttribute("cx")+"' , '"+request.getSession().getAttribute("username")+"')");
